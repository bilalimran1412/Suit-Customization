...
import { EnvelopICon, GoogleIcon, PasswordIcon } from "../components/SVGICONS";
...
const SignIn = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			// Redirect or take any action (e.g., save token, redirect to dashboard)
					...
					<div className="hidden w-full xl:block xl:w-1/2">
						<div className="px-26 py-17.5 text-center">
							<a className="mb-5.5 inline-block" href="/">
								<img className="hidden dark:block" src={"/imgs/logo/logo.svg"} alt="Logo" width={176} height={32} />
								<img className="dark:hidden" src={"/imgs/logo/logo-dark.svg"} alt="Logo" width={176} height={32} />
							</a>
